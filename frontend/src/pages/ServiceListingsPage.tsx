...
export default function ServiceListingsPage() {
  ...
  useEffect(() => {
    ...
    fetchListings();
  }, [page, limit, serviceId, minRating, location, maxPrice, minPrice, keyword, setSearchParams]);
                  ...
                  >
                    ...
                    >
                      <div className="flex flex-col md:flex-row justify-between md:items-start gap-4">
                        ...
                        <div className="bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 px-4 py-2 rounded-lg font-medium whitespace-nowrap">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between mt-6 gap-4">
                        <div className="flex items-center gap-4">
                          ...
                          >
                            <div className="bg-indigo-100 dark:bg-indigo-900/30 rounded-full size-10 flex items-center justify-center">
